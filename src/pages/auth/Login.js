        ...
        fetch(BASE_URL + '/login/', {
            ...
            .then((data) => {
                if (data.access) {
                    ...
                    this.setState({auth: {message: data.detail, error: true}})
                }
            })
            .catch((error) => {
                                    ...
                                    <CardBody className="p-0">
                                        <Row>
                                            <Col md={6} className="p-5 position-relative">
                                                ...
                                                {this.state.auth.error && <Alert color="danger" isOpen={this.state.auth.error ? true : false}>
                                                    <div>{this.state.auth.message}</div>
                                                </Alert>}
